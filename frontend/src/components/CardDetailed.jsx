...
function CardDetailed() {
  return (
    <article>
      <p className="text-small mb-[1.8rem] font-bold text-gray leading-[1.8] uppercase">Featured project</p>
      <figure>
        <picture className="rounded-t-[1rem] overflow-hidden block">
          <img src={image} alt="" />
        </picture>
        <p className="bg-green-400 text-center" id="status">
          Fully Funded
        </p>
      </figure>
